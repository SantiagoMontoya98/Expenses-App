...
$totalAmountThisMonth = $this->d['totalAmountThisMonth'];
$maxExpensesThisMonth = $this->d['maxEpensesThisMonth'];
$user = $this->d['user'];
      ...
      <div id="left-container">
          ...
          <div class="cards-container">
            <div class="card w-100">
              ...
              <div class="total-expense">
                <?php
                if ($totalAmountThisMonth === NULL)
                  echo 'Hubo un problema al cargar la información';
                else { ?>
                  <span class="<?php echo ($user->getBudget() < $totalAmountThisMonth) ? 'broken' : '' ?>">$<?php echo number_format($totalAmountThisMonth, 2); ?></span>
                <?php
                }
                ?>
              </div>
          ...
          <div class="cards-container">
            <div class="card w-50">
              <div class="total-budget">
                <span class="total-budget-text">
                  de
                  $<?php echo number_format($user->getBudget(), 2) . ' mensuales te restan'; ?>
                </span>
              </div>
              <div class="total-expense">
                ...
                if ($totalAmountThisMonth === NULL)
                  ...
                  <span>
                    <?php
                    $gap = $user->getBudget() - $totalAmountThisMonth;
                    ...
                    echo number_format(abs($user->getBudget() - $totalAmountThisMonth), 2);
        ...
        <div id="expenses-category">
          ...
          <div id="categories-container">
            ...
            <?php
            if ($categories === NULL)
              echo 'Datos no dispnibles por el momento';
            else {
            ...
            if ($expenses === NULL)
              ...
              foreach ($expenses as $expense) { ?>
                ...
                <div class="preview-expense">
                  ...
                  <div class="right">
                    <div class="expnese-amount">$<?php echo number_format($expense->getAmount(), 2); ?></div>
                  </div>
                </div>
